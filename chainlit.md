...
- Summarization and embeddings use separate chunk budgets. If your embedding endpoint rejects long inputs, lower `embedding_chunk_size_chars` without shrinking summarization chunks.
